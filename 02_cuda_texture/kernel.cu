...
//    }
//     
//    cv::cvtColor(image, imageRGBA,/* COLOR_BGR2Luv,*/ cv::COLOR_BGR2RGBA);
//
...
//
//    //load input file
//    std::string input_file = "D:/Work/ccuda/CudaRuntime/CudaTexture/cinque_terre_small.jpg";
//    //define output file
//    std::string output_file = "out_cinque_terre_small.jpg";
//
...
void postProcess(const std::string& output_file, uchar4* data_ptr) {
   ...
   // cv::imwrite(output_file.c_str(), imageOutputBGR);
    cv::imshow(output_file, imageOutputBGR);
    cv::waitKey(0);
}
